...
const initialState = {
  ...
  meals: {
    desayuno: [
      { id: 1, name: 'El Clásico', ingredients: '1 tostada pan 100% integral (60g), 1 tarrina Queso Burgos 0%, 2 lonchas pavo.', prep: 'Tostar pan. Poner queso y pavo. Café descafeinado o infusión con avena.', count: 0 },
    ...
    comida: [
      { id: 101, name: 'Día 1: Lentejas Estofadas Suaves', ingredients: '150g lentejas cocidas (bote), 100g zanahoria pelada, 100g calabacín, 1 cdta AOVE.', prep: 'Hervir zanahoria y calabacín 10 min. Añadir lentejas lavadas 3 min. AOVE en crudo al final.', count: 0 },
      ...
      { id: 105, name: 'Día 5: Solomillo de Cerdo con Boniato', ingredients: '150g solomillo cerdo magro, 150g boniato, canónigos.', prep: 'Boniato dados al micro 6 min. Solomillo plancha. Canónigos con AOVE.', count: 0 },
      ...
      { id: 107, name: 'Día 7: Guiso Pavo y Patata', ingredients: '150g pavo guisar, 150g patata, 100g zanahoria.', prep: 'Sellar pavo. Añadir agua, verdura y patata "cascada". Hervir 25 min fuego lento.', count: 0 },
      { id: 108, name: 'Día 8: Salmón Vapor con Patata', ingredients: '150g lomo salmón fresco, 150g patata pequeña.', prep: 'Estuche vapor/bolsa: patata rodajas y salmón. Sal/AOVE. 5 min microondas.', count: 0 },
      { id: 109, name: 'Día 9: Lomo con Puré de Patata', ingredients: '150g lomo cerdo, 150g patata, chorrito leche desnatada.', prep: 'Hervir y chafar patata con leche. Lomo a la plancha suave.', count: 0 },
      { id: 110, name: 'Día 10: Alubias Blancas con Verduras', ingredients: '150g alubias blancas (bote), 100g calabaza, 100g calabacín.', prep: 'Hervir verduras dados 10 min. Añadir alubias lavadas 3 min.', count: 0 },
      ...
      { id: 112, name: 'Día 12: Pasta Integral con Pavo', ingredients: '50g pasta integral, 100g fiambre pavo extra, calabacín.', prep: 'Hierve pasta. Dados calabacín/pavo salteados. Mezclar.', count: 0 },
    ...
    cena: [
      ...
      { id: 302, name: 'Día 2: Crema de Calabacín y Patata', ingredients: '2 calabacines, 1 patata mediana, leche desnatada.', prep: 'Pela, hierve 15 min, tritura fino con leche. Haz doble para el día 6.', count: 0 },
      ...
      { id: 309, name: 'Día 9: Ensalada Atún y Canónigos', ingredients: 'Canónigos, 1 lata atún natural, 1 queso Burgos 0%.', prep: 'Atún muy escurrido. Aliño muy suave. Masticar mucho.', count: 0 },
      { id: 310, name: 'Día 10: Crema de Zanahoria', ingredients: '300g zanahorias, 1/2 patata, 2 lonchas jamón cocido.', prep: 'Hervir, triturar fino. Jamón cocido picado encima.', count: 0 },
      { id: 311, name: 'Día 11: "Falso Tartar" Antirreflujo', ingredients: '100g salmón fresco (pre-congelado), 1/2 aguacate, 2 biscotes.', prep: 'Picar todo a cuchillo minúsculo. Mezclar suave con AOVE/sal.', count: 0 },
      { id: 312, name: 'Día 12: Puré de Patata con Atún', ingredients: '1 patata mediana, 1 lata atún natural.', prep: 'Patata hervida chafada con atún escurrido. Digestivo.', count: 0 },
  ...
  shoppingList: [
    // 1. COMPRA PARA 14 DÍAS (Carnes - Trocear a 150g)
    ...
    { id: 64, name: 'Salmón Ahumado', qty: '1 paquete', checked: false, cat: 'Proteína Fresca', freq: 'Semanal' },
    { id: 65, name: 'Pan de molde 100% integral', qty: '1 bolsa', checked: false, cat: 'Despensa', freq: 'Semanal' },

    // 3. COMPRA AL DÍA
    { id: 80, name: 'Sushi Salmón y Atún (Bandejas)', qty: 'Días 3 y 13. Solo 10 piezas', checked: false, cat: 'Día a Día', freq: 'Diario' }
  ],
