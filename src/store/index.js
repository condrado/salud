...
const initialState = {
  ...
  "meals": {
    ...
    "cena": [
      ...
      { "id": 304, "name": "Día 4: Caldo Pollo con Fideos", "ingredients": "30g fideos finos, 250/300 ml de caldo casero (Día 4 prep).", "prep": "Hervir fideos 3 min en el caldo. Cenar tazón caliente.", "count": 0 },
  ...
  "shoppingList": [
    ...
    { "id": 49, "name": "Nueces naturales (Bolsa)", "qty": "1 pack", "checked": false, "cat": "Despensa", "freq": "Quincenal" },
    { "id": 67, "name": "Almendras crudas (Bolsa)", "qty": "1 pack", "checked": false, "cat": "Despensa", "freq": "Quincenal" },
    { "id": 68, "name": "Caldo de Pollo (Bricks)", "qty": "1 packs (1L)", "checked": false, "cat": "Despensa", "freq": "Quincenal" },
